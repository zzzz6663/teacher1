...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'info_discount'                  => ' ﺗﻮﺿﯿﺤﺎت ﺗﺨﻔﯿﻒ',
        'info_sale'                  => '  ﺗﻮﺿﯿﺤﺎت ﺧﺮﯾﺪ  ',
        'type'                  => '  نوع  ',
        'percent'                  => '  درصد  ',
        'image'                  => '  تصویر  ',
        'show'                  => '   نمایش ',
        'transactionId'                  => '     توضیحات ',
        'ir'                  => '  شبا  ',
        'cart'                  => '  شماره کارت  ',
        'payamak'                  => '   پیامک ',
        'short '                  => ' خلاصه   ',
...
//        'en_name '                  => '   نام لاتین ',
        ...
        'meet5'                  => '   قیمت پنج  جلسه  ',
        'meet10'                  => '   قیمت ده  جلسه  ',
        'freeclass'                  => '   وضعیت جلسه رایگان  ',
        'free_meeting_price'                  => '    قیمت جلسه غیر رایگان ',
        'nofree'                  => '     غیر رایگان ',
        'article'                  => '  متن نوشته    ',
        'tag'                  => ' کلمه کلیدی    ',
        'status'                  => '    وضعیت  ',
        ...
        'language_id'                  => '   زبان   ',
        'bio'                  => '    بیوگرافی ',
        'teach_exam'                  => '   آمادگی برای آزمون  ',
        'teach_sub'                  => '   موضوعات  ',
        'teach_class'                  => '  موارد کلاس  ',
        'teach_age'                  => '    سن تدریس ',
        'teach_dialect'                  => '   لهجه تدریس   ',
        'teach_level'                  => '    سطوح تدریس ',
        'place'                  => '  محل   ',
        'from'                  => '    تاریخ شروع ',
        'till'                  => '   تاریخ پایان  ',
        'port_vid'                  => '     ویدیوی معرفی',
        'port_img'                  => '   تصویر شاخص  ',
        'reserve_meet'                  => 'رزور کلاس     ',
        'duration'                  => '  مدت زمان   ',
        'cat'                  => '   دسته بندی  ',
        'payam'                  => '  پیغام   ',
        'rate'                  => '    امتیاز ',
