...
Route::get('/teacher_register_form','HomeController@teacher_register_form')->name('home.teacher.register.form');
...
Route::get('/student_register_form','HomeController@student_register_form')->name('home.student.register.form');
...
Route::prefix('teacher')->middleware(['checkTeacher','auth'])->namespace('teacher')->group(function(){
    ...
    Route::get('/resume','TeacherController@resume')->name('teacher.resume');
    Route::get('/account','TeacherController@account')->name('teacher.account');
    Route::get('/abilite','TeacherController@abilite')->name('teacher.abilite');
    Route::get('/introduce','TeacherController@introduce')->name('teacher.introduce');
    ...
    Route::post('/save_bg/','TeacherController@save_bg')->name('teacher.save.bg');
    ...
    Route::get('/level','TeacherController@level')->name('teacher.level');
...
Route::middleware(['auth'])->group(function(){
//    Route::post('/charge_wallet/{user}','BillController@charge_wallet')->name('student.charge.wallet');
...
Route::prefix('admin')->namespace('admin')->middleware([ 'checkadmin','auth'])->group(function(){
    ...
    Route::post('/home_payam','AdminController@home_payam')->name('admin.home.payam');
    ...
    Route::post('/save_port/{user}','TeacherController@save_port')->name('admin.teacher.save.port');
