                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <h3 class="profile-username text-center">{{$teacher->name}}
                                <br>
                                ({{$teacher->mobile}} ) </h3>
...
{{--                                </li>--}}
                                <li class="list-group-item">
                                    <strong>
                                        <small class="badge badge-{{$teacher->submit?'success':'danger'}} "> {{$teacher->submit?'نمایش':'عدم نمایش'}}   نمایش      </small>
                                    </strong>
                                </li>
                                <li class="list-group-item">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            <strong><i class="fa fa-book mr-1"></i>   شماره شبا</strong>
                            <p class="text-muted">
                                {{$teacher->attr('shaba')}}
                            </p>
                            <hr>
...
{{--                                            <th>{{dd($teacher->languages())}}</th>--}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card card-widget">
                                ...
                                <div class="card-body">
                                    <video  height="240" id="player" class="js-player" playsinline controls data-poster="{{asset('/src/port_img/'.$teacher->attr('port_img'))}}">
                        ...
                        <div class="col-md-12">
                            <div class="card card-widget">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <img style="width: 300px" src="{{asset('/src/port_img/'.$teacher->attr('port_img'))}}" alt="User Image">
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">        آپلود ویدئو معلم   </h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                ...
                                <form id="port_form"  class="mwidth pt0" action="{{route('admin.teacher.save.port',$teacher->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('post')
                                    <div>
                                        <div class="form-group">
                                            <label for="video-cover"> عکس کاور    </label>
                                            <input type="file" id="video-cover" accept="image/*" name="port_img">
                                        </div>
                                        <div class="form-group">
                                            <label for="video-upload">ویدئو     </label>
