...
{{--                                            </div>--}}
                        ...
                        <div id="teacher-comment-form" style="padding: 0 30px; margint-bottom:0px">
                            ...
                            <form action="{{{route('home.comment.teacher',$user->id)}}}" method="post">
                                @csrf
                                @method('post')
                                <div class="input-container {{ (\Illuminate\Support\Facades\Auth::check())?'active':''}} icon">
                                    <span>نام*</span>
                                    <i class="right-bg">
                                    ...
                                    <input type="text" name="name" value="{{auth()->user()->name}} {{auth()->user()->family}}" placeholder="">
