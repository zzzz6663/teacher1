...
class ComController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->file('img')){
            ...
            $name_img= $language->id.'_com'.'_'.time().'.'.$file->getClientOriginalExtension();
            $file->move(public_path('/src/img/com'),$name_img);
    ...
    public function update(Request $request, Com $com)
    {
        ...
        if ($request->file('img')){
            $file=$request->file('img');
            $name_img= $com->id.'_com'.'_'.time().'.'.$file->getClientOriginalExtension();
            $file->move(public_path('/src/img/com'),$name_img);
             $com->update(['img'=>$name_img]);
        }
